...
public class ShippingService {
    ...
    public ShippingRateDTO getShippingCost(String destinationId, int weightGram, String courierFilter) {
        ...
        if (destinationCity.isEmpty()) destinationCity = destinationId;
        ...
        try {
            ...
            body.put("courier", (courierFilter == null || courierFilter.isEmpty()) ? "jne,jnt,sicepat,anteraja,pos" : courierFilter);

            com.otaku.ecommerce.dto.ShippingCostResponseDTO apiRes = restTemplate.postForObject(url, body, com.otaku.ecommerce.dto.ShippingCostResponseDTO.class);
    ...
    private ShippingRateDTO getMockShippingCost(String destinationId, int weightGram, String courierFilter) {
        ...
        for (Object[] r : catalog) {
            ...
            if (!filter.isBlank() && !filter.contains(code)) continue;
