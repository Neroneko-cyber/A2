      ...
      <div style={{ background: 'var(--card-bg)', borderRadius: '15px', border: '1px solid #333', overflow: 'hidden' }}>
        {loading ? (
          ...
          <>
                        ...
                        {order.status === 'Waiting_Verification' ? (
                          ...
                          <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                            <input 
                              ...
                              style={{ padding: '6px', background: '#111', border: '1px solid #444', color: '#fff', borderRadius: '4px', width: '70px', fontSize: '0.8rem' }}
                            />
                            <input 
                              type="text" 
                              placeholder="No. Resi" 
            ...
            {/* Pagination Controls */}
            {totalPages > 1 && (
              <div style={{ display: 'flex', justifyContent: 'center', padding: '20px', gap: '8px', borderTop: '1px solid #333' }}>
                {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
                  <button
                    ...
                    style={{
                      ...
                      border: 'none',
                      borderRadius: '6px',
                      background: currentPage === page ? 'var(--accent-crimson)' : 'rgba(255,255,255,0.1)',
                      color: '#fff',
                      cursor: 'pointer',
